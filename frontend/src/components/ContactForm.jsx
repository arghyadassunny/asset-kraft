...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        setIsSubmitted(true);
        toast.success('Thank you for contacting us! Our team will reach out to you within 24 hours.');
        setFormData({ name: '', email: '', phone: '', message: '' });
        setTimeout(() => setIsSubmitted(false), 5000);
      }
    } catch (error) {
      console.error('Contact form error:', error);
      toast.error('Something went wrong. Please try again or call us directly at ' + companyInfo.phone);
    } finally {

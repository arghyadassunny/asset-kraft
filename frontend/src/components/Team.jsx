              ...
              <div className="p-5 lg:p-6 bg-gradient-to-br from-teal-50 to-yellow-50 flex-1 flex flex-col justify-start lg:justify-between">
                ...
                {member.linkedin ? (
                  <a 
                    ...
                    className="flex items-center gap-2 text-slate-600 hover:text-teal-600 transition-colors mt-auto w-fit"
                  >
                    <Linkedin size={16} className="lg:w-[18px] lg:h-[18px]" />
                    <span className="text-xs lg:text-sm">Connect on LinkedIn</span>
                  </a>
                ) : (
                  <div className="flex items-center gap-2 text-slate-400 mt-auto opacity-50 cursor-not-allowed w-fit">
                    <Linkedin size={16} className="lg:w-[18px] lg:h-[18px]" />
                    <span className="text-xs lg:text-sm">Connect on LinkedIn</span>
                  </div>
                )}
